...
class AppError(Exception):
    pass
""")
        findings = check_dead_exceptions(t, verbose=False)
...
action2 = "update"
""")
        findings = check_dead_dispatch_entries(t, verbose=False)
        assert len(findings) == 1
...
""",
        ...
        findings = check_orphaned_test_helpers(t, verbose=False)
        assert len(findings) == 1
